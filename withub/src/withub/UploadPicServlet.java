...
public class UploadPicServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (!isMultipart) {
			request.setAttribute("fileUploadMessage", "No image uploaded.");
		...
		try {
				...
				while (i.hasNext()) {
					...
					if (!fi.isFormField()) {
						...
						String file_name = "";
						String file_path = "";
						filePath = request.getServletContext().getRealPath("/") + "profilePic\\";
						...
						request.setAttribute("fileUploadMessage", "Image uploaded successfully.");
			...
			request.setAttribute("fileUploadMessage", "Error uploading image. Please try again.");
			request.getRequestDispatcher("/Registration.jsp").forward(request, response);
