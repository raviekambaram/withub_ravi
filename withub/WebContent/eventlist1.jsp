...
<section>
		...
		<% 
            ...
            ResultSet resultset = 
                statement.executeQuery("select * from withub.events") ; 
	int i=1;
...
<!--          <div class="row text-center">-->
            ...
            <div class="col-md-3 col-sm-6 hero-feature" >
                <div class="thumbnail">
                    ...
                    <img src="<%=resultset.getString(5)%>" alt="" width="400" height="400">
                    ...
                    <div class="caption">
                        ...
                        <p><% if(session.getAttribute("email") != null)
                            ...
                            <% } %>
                            <a href="${pageContext.request.contextPath}/EventManager?event_name=<%=resultset.getString(1)%>" class="btn btn-default">More Info</a>
                        </p>
                    </div>
                </div>
            </div>
